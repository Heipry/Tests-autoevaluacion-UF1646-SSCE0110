export default [
  // Preguntas sobre Andragogía, Alumno Online, Evaluación y Videotutoriales (Eval3).
  {
  ...
  },
  {
    ...
    options: [
      "Un documento que orienta el estudio y los procesos cognitivos del alumno.",
      "Un instrumento para guiar y facilitar el aprendizaje.",
      "Un instrumento que integra todos los medios y recursos de la acción formativa.",
      "Todas son correctas.",
    ],
    correctAnswer: "Todas son correctas.",
    justification:
      "La guía didáctica es un instrumento fundamental que cumple con todos los puntos: es un instrumento para guiar y facilitar el aprendizaje, orienta el estudio y los procesos cognitivos, e integra todos los medios y recursos de la acción formativa.",
  },
  {
    question:
  ...
  },
  {
    ...
    correctAnswer: "Todas son correctas.",
    justification:
      "Los jefes de estudios son clave para la coordinación entre los agentes educativos. Sus funciones incluyen: coordinar el trabajo de los tutores, contribuir a su proceso formativo (capacitación) y asesorar en la planificación de horarios y tareas.",
  },
  {
